...
const CrytoDetails = () => {
    const { coinId } = useParams(); // lets you extract coinid from url. Like for 1st cryptocurr, url in our app is /1 so coinId will be 1
    ...
    //console.log(cryptoDetails, 'details');
